...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="courses">
    ...
    <p>
    <a class = "pdflink" href = "{concat('/cocoon/final/courses/',$cat_num,'.pdf')}">PDF</a> 
    </p>
    ...
    <xsl:for-each-group select="/courses/course[@cat_num eq $cat_num]" group-by="course_group">
      ...
      <div class = "course_container">
        ...
        <div class="detailnav">
          <a href="/cocoon/final/index.html">Departments</a>
          <img src="/cocoon/final/images/arrow.gif" alt="Arrow"/>
          <a href="{concat('/cocoon/final/course_groups/',department/@code,'.html')}">
